...
enum CreatureFlagsExtra : uint32
{
    ...
    CREATURE_FLAG_EXTRA_UNUSED_27            = 0x00800000,       // Creature will always be visible to the player. Only usable on creatures with entries 190000 or higher (on purpose)
