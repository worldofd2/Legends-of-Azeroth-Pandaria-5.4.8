    ...
    public:
        ...
        struct instance_uldaman_InstanceMapScript : public InstanceScript
        {
            ...
            void Initialize() override
            {
                ...
                archaedasGUID = ObjectGuid::Empty;
                ironayaGUID = ObjectGuid::Empty;
                whoWokeuiArchaedasGUID = ObjectGuid::Empty;
                altarOfTheKeeperTempleDoor = ObjectGuid::Empty;
                archaedasTempleDoor        = ObjectGuid::Empty;
                ancientVaultDoor           = ObjectGuid::Empty;
                ironayaSealDoor            = ObjectGuid::Empty;
                teamInInstance             = ObjectGuid::Empty;
                keystoneGUID = ObjectGuid::Empty;
                archaedasAltarGUID = ObjectGuid::Empty;
            ...
            std::vector<ObjectGuid> stoneKeepers;
            std::vector<ObjectGuid> altarOfTheKeeperCounts;
            std::vector<ObjectGuid> vaultWalkers;
            std::vector<ObjectGuid> earthenGuardians;
            ...
            void ActivateStoneKeepers()
            {
                ...
                {
                    for (std::vector<ObjectGuid>::const_iterator i = stoneKeepers.begin(); i != stoneKeepers.end(); ++i)
                    {
            ...
            void ActivateWallMinions()
            {
                ...
                for (std::vector<ObjectGuid>::const_iterator i = archaedasWallMinions.begin(); i != archaedasWallMinions.end(); ++i)
                {
                    Creature* target = instance->GetCreature(*i);
            ...
            void DeActivateMinions()
            {
                ...
                // Vault Walkers
                for (std::vector<ObjectGuid>::const_iterator i = vaultWalkers.begin(); i != vaultWalkers.end(); ++i)
                {
                    Creature* target = instance->GetCreature(*i);
                    if (!target || target->isDead() || target->GetFaction() != 14)
                        continue;
                ...
                // Earthen Guardians
                for (std::vector<ObjectGuid>::const_iterator i = earthenGuardians.begin(); i != earthenGuardians.end(); ++i)
                {
                    Creature* target = instance->GetCreature(*i);
                    if (!target || target->isDead() || target->GetFaction() != 14)
                        continue;
