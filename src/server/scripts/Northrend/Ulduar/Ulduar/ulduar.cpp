...
void AddSC_ulduar()
{
    ...
    new spell_script<spell_ulduar_teleporter>("spell_ulduar_teleporter");
    //new spell_script<spell_ulduar_random_aggro_periodic>("spell_ulduar_random_aggro_periodic");
}
